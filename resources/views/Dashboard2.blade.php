...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-3 text-right">
            ...
            <a href="{{url('/logout')}}" class="small mr-3"><span class="icon-unlock-alt"></span> Log Out</a>
            <a href="{{route('register.create')}}" class="small btn btn-primary px-4 py-2 rounded-0"><span class="icon-users"></span> Register</a>
            <?php } ?>
          </div>
        </div>
      </div>
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('template/dash/images/hero_1.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Welcome to HiBrain!</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="intro-section" style="background-image: url('template/dash/images/hero_1.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Lets learn about programming!</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url('template/dash/images/bg_1.jpg')">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
