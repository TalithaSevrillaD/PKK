    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Membuat Web Dinamis dengan Bahasa Pemrograman PHP</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-4">
                    <p>
                        <img src="template/dash/images/courses/PHP.png" alt="Image" class="img-fluid">
                    </p>
                </div>
                <div class="col-lg-5 ml-auto align-self-center">
                        ...
                        <p><strong class="text-black d-block">Pengertian :</strong>PHP merupakan singkatan dari Hypertext Preprocessor adalah
                          bahasa pemrograman yang digunakan untuk membuat sebuah website yang dinamis.</p>
                        <p class="mb-5"><strong class="text-black d-block">Tentang PHP :</strong>Bahasa pemrograman PHP dibuat pertama kali
                          oleh Rasmus Lerdorf pada tahun 1995. Nama awalnya yaitu Form Interpreted (FI) yang merupakan skrip-skrip yang bisa
                          dipakai untuk mengolah data formulir dari sebuah website. Kemudian Rasmus merilisnya untuk umum dan memberikannya
                          nama PHP/ FI. Setelah itu PHP menjadi open source, sehingga banyak sekali programmer yang tertarik untuk ikut serta
                          mengembangkan bahasa pemrograman PHP.</p>

                        <p>
                            <a href="{{url('/php1')}}" class="btn btn-primary rounded-0 btn-lg px-5">Enroll</a>
                        </p>
