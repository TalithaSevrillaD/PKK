    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Membuat Web Lebih Dinamis dengan CSS</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-4">
                    <p>
                        <img src="template/dash/images/courses/CSS3.jpg" alt="Image" class="img-fluid">
                    </p>
                </div>
                <div class="col-lg-5 ml-auto align-self-center">
                        ...
                        <p><strong class="text-black d-block">Pengertian :</strong>CSS adalah kepanjangan dari Cascading
                          Style Sheet yang berfungsi untuk mengatur tampilan elemen yang tertulis dalam bahasa markup.
                          Fungsi lain dari CSS yakni untuk memisahkan konten dari tampilan visual dalam sebuah website.</p>
                        <p class="mb-5"><strong class="text-black d-block">Tentang CSS :</strong>Pada awal dibuat tahun
                          1996 silam, CSS sendiri difungsikan untuk memformat halaman. Selain itu, permasalahan seperti
                          tags font yang diperkenalkan HTML menyebabkan banyak masalah bagi developer, dikarenakan website
                          membutuhkan font, warna background, dan style maka CSS dapat menyelesaikan masalah ini.</p>

                        <p>
                            <a href="{{url('/css1')}}" class="btn btn-primary rounded-0 btn-lg px-5">Enroll</a>
                        </p>
