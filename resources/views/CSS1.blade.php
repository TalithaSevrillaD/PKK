    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Mengetahui lebih lanjut tentang CSS</h2>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="carousel slide" data-ride="carousel" id="slide">
              ...
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img src="template/dash/images/courses/Materi CSS/1.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/2.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/3.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/4.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/5.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/6.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/7.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/8.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/9.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/10.png" width="100%" height="500" alt="">
                  </div>
                  <div class="carousel-item">
                      <img src="template/dash/images/courses/Materi CSS/11.png" width="100%" height="500" alt="">
                  </div>
              </div>
